...
# vi: set ft=ruby :
#
vagrant_plugins = ['puppet','vagrant-r10k', 'vagrant-vbguest', 'vagrant-puppet-install', 'vagrant-hosts', ]
...
Vagrant.configure(2) do |config|
  ...
  config.r10k.module_path = "puppet/vendor/modules"

  # Provision the machine with the appliction
  config.vm.provision "puppet" do |puppet|
    puppet.options = '--debug --verbose --summarize --reports store --hiera_config=/vagrant/puppet/hiera.yaml'
